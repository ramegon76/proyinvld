...
La descripción original del proceso de producción EPTPTASS recoge el flujo de actividades y datos como un proceso experimental en el que se buscó comparar la eficiencia de diversas herramientas tecnológicas para generar las estadísticas de interés a partir de los registros administrativos del IMSS e ISSSTE. Esta documentación refleja la visión de área productora antes de incorporar los *criterios* al proceso y configurarlo con base el MPEG.

El diagrama que se muestra a continuación fue elaborado en colaboración con el personal de la *Dirección General Adjunta de Registros Administrativos Sociodemográficos*, y muestra las fases, actividades y tareas tal como se llevaron a cabo en su contexto operativo original, ofreciendo una perspectiva clara de cómo el área mencionada gestionó la producción en este proceso. Esta documentación permite comprender la estructura y secuencia de las acciones involucradas, facilitando la identificación de los procedimientos y datos que se producen y constituye la base sobre la cual se aplican los *criterios* definidos en las siguientes secciones. 
